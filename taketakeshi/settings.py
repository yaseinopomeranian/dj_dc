"""
Django settings for taketakeshi project.
...
SECRET_KEY = 'django-insecure-o6#ap2btqs5flq_fb+dofvpjps6+v86^$gs(2(l8v7d+h&ktt)'
...
WSGI_APPLICATION = 'taketakeshi.wsgi.application'
